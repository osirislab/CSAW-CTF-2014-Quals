...
'''REMOVE BEFORE GIVING TO CONTESTANTS

csawKey= "Well done young scallywag, here is the key{This is my pad there are many like it but this pad is my own}"
p1="Twenty years from now you will be more disappointed by the things that you didn't do than by the ones you did do, so throw off the bowlines, sail away from safe harbor, catch the trade winds in your sails.  Explore, Dream, Discover."
p2="When I was 5 years old, my mother always told me that happiness was the key to life.  When I went to school, they asked me what I wanted to be when I grew up.  I wrote down 'happy'.  They told me I didn't understand the assignment, and I told them they didn't understand life. "
p3="First, have a definite, clear practical ideal; a goal, an objective. Second, have the necessary means to achieve your ends; wisdom, money, materials, and methods. Third, adjust all your means to that end."
p4="How much wood would a woodchuck chuck if a wood chuck could chuck wood"
p5="There's a little boy and on his 14th birthday he gets a horse... and everybody in the village says, \"how wonderful. The boy got a horse\" And the Zen master says, \"we'll see.\" Two years later, the boy falls off the horse, breaks his leg, and everyone in the village says, \"How terrible.\" And the Zen master says, \"We'll see.\" Then, a war breaks out and all the young men have to go off and fight... except the boy can't cause his legs all messed up. and everybody in the village says, \"How wonderful.\" Now the zen master says, \"we'll see\""

base=[csawKey,p1,p2,p3,p4,p5]
toCrypt=map(lambda x:array.array("B",x),base)
kLen= max(toCrypt,key=len)
kLen= len(kLen)
cKey=os.urandom(kLen)
cKey=array.array("B",cKey)
'''
